                ...
                children: [
                  ...
                  Stack(
                    children: [
                      ...
                      _buildLocationIcon(context, 8, 10, lectureIdList[0]),
                      _buildLocationIcon(context, 40, 10, lectureIdList[1]),
                      _buildLocationIcon(context, 250, 10, lectureIdList[2]),
                      _buildLocationIcon(context, 100, 10, lectureIdList[3]),
                      _buildLocationIcon(context, 8, 130, lectureIdList[0]),
                      _buildLocationIcon(context, 100, 230, lectureIdList[1]),
                      _buildLocationIcon(context, 250, 120, lectureIdList[2]),
                      _buildLocationIcon(context, 100, 300, lectureIdList[3]),
                      _buildLocationIcon(context, 8, 10, lectureIdList[0]),
                      _buildLocationIcon(context, 40, 10, lectureIdList[1]),
                      _buildLocationIcon(context, 250, 10, lectureIdList[2]),
                      _buildLocationIcon(context, 100, 10, lectureIdList[3]),
                      _buildLocationIcon(context, 250, 300, lectureIdList[0]),
                      _buildLocationIcon(context, 300, 230, lectureIdList[1]),
                    ],
                  ),
                ],
              ),
